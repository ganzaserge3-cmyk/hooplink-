...
function FeedPageContent() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 pb-24">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {feedTabs.map((option) => (
              <button
                key={option.value}
                type="button"
                className={`rounded-full border px-4 py-2 text-sm font-medium transition-colors ${activeFilters.view === option.value ? "border-primary bg-primary/5 text-primary" : "hover:border-primary/30"
                  }`}
        ...
        <CardContent className="p-4">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            <button
              ...
              className="flex min-w-[76px] flex-col items-center gap-2 group"
            >
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 via-red-500 to-yellow-500 p-[3px] shadow-lg group-hover:shadow-xl transition-shadow">
                ...
                <span className="absolute bottom-0 right-0 flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-orange-500 to-red-500 text-sm font-bold text-white shadow-lg border-2 border-background">
                  +
                </span>
              </div>
      ...
      <FollowSuggestions limit={5} title="People You May Know" />
