                ...
                <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                  {files.map((file, index) => (
                    <div key={`${file.name}-${index}`} className="rounded-xl border bg-muted/30 p-3 text-sm">
                      ...
                      <p className="text-xs text-muted-foreground">{file.type.startsWith("video/") ? "Video" : "Image"} ΓÇó slide {index + 1}</p>
                    </div>
                  ))}
                </div>
              ) : null}
              ...
              <div className="rounded-xl border p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {collaboratorMatches.slice(0, 8).map((profile) => (
                    ...
                    >
                      {profile.displayName} {profile.username ? `ΓÇó ${profile.username}` : ""}
                    </button>
                  ))}
